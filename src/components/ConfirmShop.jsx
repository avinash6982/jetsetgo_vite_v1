    ...
    <>
      <div className="w-full h-full">
        ...
        <div className="w-full h-full flex flex-col items-start gap-10 mt-14">
          ...
          >
            <button className="py-2 px-4 border-[1px] border-[#605DEC] text-[#605DEC] bg-white rounded hover:bg-[#605DEC] hover:text-white hover:border-[#605DEC] transition-all duration-200">
              Shop all hotels
            </button>
          </Link>
        </div>
