      ...
      <div className="flex flex-col gap-10 px-8">
        <div className="flex items-center justify-center">
          <h1 className="text-[#6E7491] font-medium md:font-bold sm:text-base md:text-[24px] md:leading-8">
            What <span className="text-[#605DEC]">JetSetGo</span> users are
            saying
          </h1>
        </div>
          ...
          <div className="flex-1 flex max-w-[410px] gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[#27273F] text-base">
                What a great experience using JetSetGo! I booked all of my
                flights for my gap year through JetSetGo and never had any
                issues. When I had to cancel a flight because of an emergency,
                JetSetGo support helped me{" "}
          ...
          <div className="flex-1 flex max-w-[410px] gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[#27273F] text-base">
                ...
                flights using other services. JetSetGo was recommened to us by a
          ...
          <div className="flex-1 flex max-w-[410px] gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[#27273F] text-base">
                ...
                JetSetGo had the best browsing experiece so I figured I’d give
                it a try. It was my first time using JetSetGo, but I’d
