        ...
        <div className="w-full lg:w-[756px] flex flex-col items-start gap-16">
          ...
          <div className=" w-full flex flex-col items-start justify-start gap-2">
            ...
            <p className="text-[#7C8DB0] text-sm sm:text-base font-medium">
              Thank you for booking your travel with JetSetGo! Below is a
              summary of your trip to Narita airport in Tokyo, Japan. We’ve sent
              a copy of your booking confirmation to your email address. You can
              also find this page again in{" "}
